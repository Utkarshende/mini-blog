    ...
    <div className='border p-4 my-4 rounded-md relative'> 
      ...
      <div>
       ...
       <p>{author.email}</p>
        ...
        <p className='text-sm mt-2'>Published On: {new Date(publishedAt || updatedAt).toLocaleString()}</p>
...
{
    status !== "published" ? (
        <span className='bg-gray-700 text-white px-6 py-2 rounded-md
        right-10 cursor-pointer mr-2 top-2'>
            {status}
        </span>) : null 
}
{
